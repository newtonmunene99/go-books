...
func (cq *CategoryQuery) QueryBooks() *BookQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2M, false, category.BooksTable, category.BooksPrimaryKey...),
		)
...
func (cq *CategoryQuery) WithBooks(opts ...func(*BookQuery)) *CategoryQuery {
	query := &BookQuery{config: cq.config}
	...
	if query := cq.withBooks; query != nil {
		...
		_spec := &sqlgraph.EdgeQuerySpec{
			...
			Predicate: func(s *sql.Selector) {
				s.Where(sql.InValues(category.BooksPrimaryKey[0], fks...))
			},
